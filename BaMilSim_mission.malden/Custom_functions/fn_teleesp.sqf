			...
			[] spawn
				{
					...
					{
						if(isNil "BaMilSim_ESPTOOL") then
						{
						BaMilSim_ESPTOOL = ["BaMilSim_ESPTOOL","onEachFrame","playerESP"] call BIS_fnc_addStackedEventHandler;
						};
					 sleep 1;
					};
				// Delete ESP Markers
				["BaMilSim_ESPTOOL", "onEachFrame"] call BIS_fnc_removeStackedEventHandler;
				BaMilSim_ESPTOOL = nil;
				true
				};
		};
